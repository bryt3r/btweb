...
<head>
    ...
    <title> Admin - {{$page_title??'HOME'}}</title>
</head>
                ...
                <div id="nav_content" class="flex_row">
                        <div id="brand_logo" class="brand_logo">
                                <a href="{{ route('beta-home') }}">
                                    <img src="{{ asset('assets/images/beta_logo_blue.svg') }}" alt="">
                                </a>
                        </div>
                        <ul class="dash_nav_links flex_row">
            ...
            <div class="dash_page_wrapper flex_row">
                <div id="dash_nav_toggle" class="dash_side_nav">
                    <ul class="dash_side_ul flex_col">
                        ...
                        <li class="dash_side_link"><a href="{{route('projects.manage')}}"><i class="fa-solid fa-person-digging"></i> Projects</a></li>
                       
                        @if (Auth::user()->is_admin)
                            <li class="dash_side_link"><a href="{{route('categories')}}"><i class="fa-solid fa-shapes"></i> Categories</a></li>
                            <li class="dash_side_link"><a href="{{route('brands')}}"><i class="fa-solid fa-ribbon"></i> Brands</a></li>
                            <li class="dash_side_link"><a href="{{route('admin.users')}}"><i class="fa-solid fa-users-gear"></i> Users</a></li>
                            <li class="dash_side_link"><a href="{{route('page_visits')}}"><i class="fa-solid fa-eye "></i> Visits</a></li>
                        @endif
                        <br>
                        <br>
